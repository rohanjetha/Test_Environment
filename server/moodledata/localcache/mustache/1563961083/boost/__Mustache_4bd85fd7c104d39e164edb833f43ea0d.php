...
class __Mustache_4bd85fd7c104d39e164edb833f43ea0d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockBaf90d4ce1087c7557cd4083836d7b00'),
            ));
...
';
    ...
    public function blockBaf90d4ce1087c7557cd4083836d7b00($context)
    {
        $indent = $buffer = '';
