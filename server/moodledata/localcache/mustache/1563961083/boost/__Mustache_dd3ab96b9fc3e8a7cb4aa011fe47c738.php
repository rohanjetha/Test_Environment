...
class __Mustache_dd3ab96b9fc3e8a7cb4aa011fe47c738 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block552ee5f868b5513ddd60840bf51b757e'),
            ));
...
';
    ...
    public function block552ee5f868b5513ddd60840bf51b757e($context)
    {
        $indent = $buffer = '';
