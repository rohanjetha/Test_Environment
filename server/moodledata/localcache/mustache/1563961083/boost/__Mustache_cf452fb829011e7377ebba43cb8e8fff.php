...
class __Mustache_cf452fb829011e7377ebba43cb8e8fff extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section001113850240f072f9e7b455e94db881($context, $indent, $value);
        }
...
';
    ...
    private function section001113850240f072f9e7b455e94db881(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
