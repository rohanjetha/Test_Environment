...
class __Mustache_30870b08ec49a0cd732202a3be24fe80 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionDdf064db46a2253e744033c57ca86ca1($context, $indent, $value);
        }
        $buffer .= '
';
...
';
        // 'error' section
        $value = $context->find('error');
        $buffer .= $this->section5332233a71962ff0d9de570578207dbb($context, $indent, $value);
        $buffer .= ' ';
...
';
    ...
    private function sectionAf31bb353943c5c127aa30aebec2f991(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionDdf064db46a2253e744033c57ca86ca1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                // 'element.checked' section
                $value = $context->findDot('element.checked');
                $buffer .= $this->sectionAf31bb353943c5c127aa30aebec2f991($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function section5332233a71962ff0d9de570578207dbb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
