...
class __Mustache_0adb36accc62a4529701a859f017f859 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block92f0d3dea9b6e2ccd5c2844a79636710'),
            ));
...
';
    ...
    public function block92f0d3dea9b6e2ccd5c2844a79636710($context)
    {
        $indent = $buffer = '';
