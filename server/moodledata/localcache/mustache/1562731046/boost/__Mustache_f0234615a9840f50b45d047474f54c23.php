...
class __Mustache_f0234615a9840f50b45d047474f54c23 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block450cb09aec79777cd55ba47fa38a9e08'),
            ));
...
';
    ...
    public function block450cb09aec79777cd55ba47fa38a9e08($context)
    {
        $indent = $buffer = '';
