...
class __Mustache_9661068c219979af81b1a1c358af7db5 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF476b3ebe07c07d315d0bba7be371098($context, $indent, $value);
        $buffer .= $indent . '        </tbody>
';
        $buffer .= $indent . '    </table>
';
...
';
    ...
    private function sectionE195edfe8909e6219d0f0806dad16836(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section3fc885dab071955a9f18a5d8be55c761(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                if ($parent = $this->mustache->loadPartial('core_calendar/minicalendar_day_link')) {
                    $context->pushBlockContext(array(
                        ...
                        'content' => array($this, 'block527badebe50528b0361b216bbf07aeab'),
                    ));
    ...
    private function section4f4edd2793ed3d653a7a1de6c4f66b81(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section3fc885dab071955a9f18a5d8be55c761($context, $indent, $value);
...
';
    ...
    private function sectionF476b3ebe07c07d315d0bba7be371098(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section4f4edd2793ed3d653a7a1de6c4f66b81($context, $indent, $value);
                // 'postpadding' section
...
';
    ...
    public function block527badebe50528b0361b216bbf07aeab($context)
    {
        $indent = $buffer = '';
        // 'events' section
        $value = $context->find('events');
        $buffer .= $this->sectionE195edfe8909e6219d0f0806dad16836($context, $indent, $value);
