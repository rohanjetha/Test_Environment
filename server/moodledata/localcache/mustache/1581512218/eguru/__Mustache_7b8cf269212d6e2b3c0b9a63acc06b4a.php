...
class __Mustache_7b8cf269212d6e2b3c0b9a63acc06b4a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block0e18b430e4e3f6c5373b5b558718cd0c'),
            ));
...
';
    ...
    public function block0e18b430e4e3f6c5373b5b558718cd0c($context)
    {
        $indent = $buffer = '';
