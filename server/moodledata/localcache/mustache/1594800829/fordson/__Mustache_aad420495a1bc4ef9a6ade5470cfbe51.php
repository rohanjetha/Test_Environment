...
class __Mustache_aad420495a1bc4ef9a6ade5470cfbe51 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section7547444e62a00291bfe5b96957a072de($context, $indent, $value);
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                </div>
';
...
';
    ...
    private function section7547444e62a00291bfe5b96957a072de(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                            <div class="modchooser_{{id}} modchoosersection">
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                            <div class="modchooser_';
                $value = $this->resolveValue($context->find('id'), $context);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= ' modchoosersection">
';
